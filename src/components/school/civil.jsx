...
const civil = (props) => {
  const civil = [
    ...
    {
      text: "Civil Engineering with Computer Applications",
      handler:props.actionProvider.civil2,
      id: 2,
    },
    {
      text: "Civil Engineering w/s Structural Engineering",
      handler:props.actionProvider.civil3,
      id: 3,
    },
    {
      text: "Civil Engineering w/s Geotechnical Engineering",
      handler:props.actionProvider.civil4,
      id: 4,
    },
    {
      text: "Civil Engineering w/s Transportation Engineering",
      handler:props.actionProvider.civil5,
      id: 5,
    },
    {
      text: "Civil Engineering w/s Water Resources and Environmental Engineering",
